...
<li class="active"><a class="nav-link" href="<?= site_url() ?>"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
...
<li class="active"><a class="nav-link" href="<?= site_url('anggota') ?>"><i class="fas fa-user"></i> <span>Anggota</span></a></li>
<li class="active"><a class="nav-link" href="<?= site_url('pengunjung') ?>"><i class="fas fa-users"></i> <span>Pengunjung</span></a></li>